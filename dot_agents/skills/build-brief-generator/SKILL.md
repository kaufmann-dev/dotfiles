...
description: Turn a messy product idea into a clear, complete, practical AI Build Brief ready for coding agents. Use only when the user explicitly invokes this skill.
---
