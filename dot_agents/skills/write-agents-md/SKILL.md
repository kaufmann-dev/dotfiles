...
description: Create a missing repository- or subtree-scoped AGENTS.md from evidence in the codebase. Use when the user asks to create a missing AGENTS.md from repository evidence.
---
