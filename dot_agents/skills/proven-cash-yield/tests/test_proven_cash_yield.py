...
class ProvenCashYieldTests(unittest.TestCase):
    ...
    def test_owner_cash_uses_three_periods(self) -> None:
        history, error = MODULE.owner_cash_history(self.companyfacts())
    ...
    def test_latest_restatement_wins(self) -> None:
        ...
        history, _ = MODULE.owner_cash_history(facts)
    ...
    def test_missing_stock_comp_is_not_zero(self) -> None:
        ...
        history, error = MODULE.owner_cash_history(facts)
    ...
    def test_snapshot_price_precedence(self) -> None:
        price, timestamp = MODULE.price_from_snapshot(
            {
                "lastTrade": {"p": 11, "t": 4},
                "min": {"c": 10, "t": 3},
                "prevDay": {"c": 9},
    ...
    def test_total_debt_prevents_component_double_counting(self) -> None:
        ...
        self.assertEqual(MODULE.latest_debt(facts), 100)
