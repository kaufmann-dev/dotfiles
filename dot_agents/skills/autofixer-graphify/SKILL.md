...
description: Coordinate the autofixer audit-fix-verify loop with Graphify repository graph context. Use only when the user explicitly invokes this skill.
---
